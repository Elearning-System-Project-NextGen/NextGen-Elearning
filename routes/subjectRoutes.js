...
router.patch("/:id", authMiddleware, restrictTo("admin", "teacher"), SubjectController.update);
router.delete("/:id", authMiddleware, restrictTo("admin", "teacher"), SubjectController.delete);
